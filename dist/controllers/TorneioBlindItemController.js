...
module.exports = {
    async get(req, res, next) {
        await (0, getRegistros_1.getRegistros)(Torneio_1.TorneioBlindItem, req, res, next);
    },
    async add(req, res, next) {
        try {
            ...
            console.log('------------------------------------------------------');
            const registro = await Torneio_1.TorneioBlindItem.create(req.body);
    ...
    async edit(req, res, next) {
        try {
            ...
            const registro = await Torneio_1.TorneioBlindItem.findByPk(id);
            if (!registro) {
