...
module.exports = {
    async get(req, res, next) {
        await (0, getRegistros_1.getRegistros)(EstruturaTorneio_1.EstruturaTorneio, req, res, next, [
            {
                model: EstruturaTorneio_1.Blind,
                as: 'blind',
    ...
    async add(req, res, next) {
        try {
            ...
            const registro = await EstruturaTorneio_1.EstruturaTorneio.create(req.body);
    ...
    async edit(req, res, next) {
        try {
            ...
            const registro = await EstruturaTorneio_1.EstruturaTorneio.findByPk(id);
            if (!registro) {
