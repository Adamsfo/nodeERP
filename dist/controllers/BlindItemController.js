...
module.exports = {
    async get(req, res, next) {
        await (0, getRegistros_1.getRegistros)(EstruturaTorneio_1.BlindItem, req, res, next);
    },
    async add(req, res, next) {
        try {
            ...
            console.log('------------------------------------------------------');
            const registro = await EstruturaTorneio_1.BlindItem.create(req.body);
    ...
    async edit(req, res, next) {
        try {
            ...
            const registro = await EstruturaTorneio_1.BlindItem.findByPk(id);
            if (!registro) {
