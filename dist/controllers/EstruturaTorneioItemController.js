...
module.exports = {
    async get(req, res, next) {
        await (0, getRegistros_1.getRegistros)(EstruturaTorneio_1.EstruturaTorneioItem, req, res, next);
    },
    async add(req, res, next) {
        try {
            ...
            const attributes = EstruturaTorneio_1.EstruturaTorneioItem.getAttributes();
            ...
            const registro = await EstruturaTorneio_1.EstruturaTorneioItem.create(req.body);
    ...
    async edit(req, res, next) {
        try {
            ...
            const registro = await EstruturaTorneio_1.EstruturaTorneioItem.findByPk(id);
            if (!registro) {
